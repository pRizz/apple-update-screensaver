...
var G__26241 = o;
(G__26241[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26245 = o;
(G__26245[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__26250 = props;
var G__26250__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26250,cljs.core.cst$kw$id,id):G__26250);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26250__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26251){
...
var props = map__26252__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26252__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26252,map__26252__$1,props,class$){
return (function (c){
...
});})(map__26252,map__26252__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26254){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26255__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26255,map__26255__$1,on_write){
return (function (){
...
});})(node_value,map__26255,map__26255__$1,on_write))
);
} else {
...
var G__26258 = jsprops;
(G__26258["defaultValue"] = value);

(G__26258["onChange"] = ((function (G__26258,v,value,on_change){
return (function (p1__26257_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26257_SHARP_);
});})(G__26258,v,value,on_change))
);
...
var vec__26261 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26261,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26261,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26261,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___26265 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___26265 == null)){
} else {
var key_26266 = temp__5739__auto___26265;
(jsprops["key"] = key_26266);
}
...
var temp__5739__auto___26267 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___26267 == null)){
} else {
var key_26268 = temp__5739__auto___26267;
reagent.impl.template.oset(jsprops,"key",key_26268);
}
...
var G__26269 = reagent.impl.template.__GT_NativeWrapper();
(G__26269["name"] = c);
...
var G__26270 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26270) : reagent.impl.template.as_element.call(null,G__26270));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26274){
var G__26275 = cljs.core.first(seq26274);
var seq26274__$1 = cljs.core.next(seq26274);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26275,seq26274__$1);
});
...
var n__4607__auto___26283 = a.length;
var i_26284 = (0);
while(true){
if((i_26284 < n__4607__auto___26283)){
(a[i_26284] = reagent.impl.template.as_element((a[i_26284])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26286 = a.length;
var i_26287 = (0);
while(true){
if((i_26287 < n__4607__auto___26286)){
var val_26288 = (a[i_26287]);
if(((cljs.core.vector_QMARK_(val_26288)) && ((reagent.impl.template.key_from_vec(val_26288) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26287] = reagent.impl.template.as_element(val_26288));

var G__26289 = (i_26287 + (1));
i_26287 = G__26289;
continue;
} else {
}
...
var ctx = ({});
var vec__26290 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26290,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26290,(1),null);
...
var G__26293 = (cljs.core.count(argv) - first_child);
switch (G__26293) {
case (0):
...
case (1):
var G__26294 = comp;
var G__26295 = jsprops;
var G__26296 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__26294,G__26295,G__26296) : reagent.impl.template.global$module$react.createElement.call(null,G__26294,G__26295,G__26296));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__26293){
